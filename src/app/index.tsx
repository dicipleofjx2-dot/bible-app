              ...
              <InvCard>
                <View style={styles.accountRow}>
                  ...
                  <Pressable onPress={signOut}>
                    <ThemedText style={[Type.caption, { color: theme.accent }]}>로그아웃</ThemedText>
                  </Pressable>
                </View>
              </InvCard>
...
const styles = StyleSheet.create({
  ...
  accountRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: Spacing.three },
  flex: { flex: 1 },
});
