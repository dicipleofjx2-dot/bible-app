          ...
          {loading ? (
            ...
            <>
              ...
              <SearchBox
                ...
                onSubmit={() =>
                  router.push(`/${orgId}/search?q=${encodeURIComponent(query)}`)
                }
              />
              ...
              <View style={styles.quickRow}>
                <QuickButton
                  emoji="📷"
                  label="물품 등록"
                  onPress={() => router.push(`/${orgId}/new`)}
                />
                <QuickButton
                  emoji="🔍"
                  label="찾기"
                  onPress={() => router.push(`/${orgId}/search`)}
                />
                <QuickButton emoji="🗄️" label="공간 추가" onPress={() => setFormOpen(true)} />
                <QuickButton
                  emoji="🧾"
                  label="관리"
                  onPress={() => router.push(`/${orgId}/manage`)}
                />
              </View>
                  ...
                  {roots.map((space) => {
                    ...
                    return (
                      <InvCard
                        ...
                        onPress={() => router.push(`/${orgId}/space/${space.id}`)}>
                        <PhotoFrame
              ...
              {unplaced.length > 0 ? (
                <InvCard onPress={() => router.push(`/${orgId}/search?unplaced=1`)}>
