...
export const STRINGS = {
  ...
  'home.arcade': { ko: '창세기 아케이드', en: 'Genesis Arcade' },
  'home.arcadeLead': {
    ko: '한 판을 끝까지 통과할 때마다 30포인트',
    en: 'Clear a game and earn 30 points',
  },
  'home.arcadeDesc': {
    ko: '막고 · 쌓고 · 피하고 · 붙들고 · 받아 던지는 다섯 판',
  ...
  'growth.english': { ko: '수능영어 코치ON', en: 'CSAT English CoachON' },
  'growth.englishDesc': {
    ko: '진단·유형학습·AI 복습노트',
    en: 'Diagnosis, type drills, AI review notes',
  },
  ...
  'nav.arcade': { ko: '창세기 아케이드', en: 'Genesis Arcade' },
  // 수능영어 코치ON — 학습 앱 영역.
  'nav.english': { ko: '수능영어 코치ON', en: 'CSAT English CoachON' },
  'nav.englishDiagnostic': { ko: '진단평가', en: 'Diagnostic Test' },
  'nav.englishTypes': { ko: '유형 학습실', en: 'Question Types' },
  'nav.englishTypeRoom': { ko: '유형 학습', en: 'Type Room' },
  'nav.englishQuiz': { ko: '문제 풀이', en: 'Practice' },
  'nav.englishReview': { ko: 'AI 복습노트', en: 'AI Review Notes' },
  'nav.englishReport': { ko: '성장 리포트', en: 'Progress Report' },
  'nav.englishBank': { ko: '문제은행', en: 'Question Bank' },
  'nav.englishMock': { ko: '실전 미니 모의고사', en: 'Mini Mock Exam' },
